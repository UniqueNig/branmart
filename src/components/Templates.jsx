    ...
    <>
      <section className="py-5 mt-5">
        <div className="container">
          {/* <!-- Small Label --> */}
          <p className={`text-center mb-1 ${style.howItWorkspara}`}>
            Beautiful Templates
          </p>

          {/* <!-- Main Title --> */}
          <h2 className={`text-center fw-bold mb-2 ${style.buildToRun}`}>
            PREMIUM TEMPLATES BUILT FOR <br />
            EVERY INDUSTRY
          </h2>

          <p className={`text-center text-muted mb-4 ${style.buildToRunPara}`}>
            Pick a Template, Customize, and Launch
          </p>

          {/* <!-- Filter Buttons --> */}
          <div className="d-flex justify-content-center flex-wrap mb-4 gap-2">
            <button className={`btn ${style["filter-btn"]} ${style.active}`}>All</button>
          ...
          <div className="row g-4">
            ...
            <div className="col-md-4">
              <div className={`${style['template-card']} fadeInUp position-relative`}>
                <img
                  src={image12}
          ...
          <div className="text-center mt-5">
            <Link to={'/templates'}>            <button className={`btn ${style['btn-orange']} px-4 py-2 rounded-pill`}>
              View all templates →
            </button> </Link>
