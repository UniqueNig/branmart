    ...
    <section className="py-5 mb-4">
      <div className="container">
        ...
        <div className="row g-4 justify-content-center">
          ...
          <div className="col-lg-3">
            <div
              className={`${style.highlightCol} rounded-4 text-center p-4 d-flex flex-column gap-4`}
            >
          ...
          <div className="col-lg-3">
            <div className="d-flex flex-column text-center p-4 gap-4">
              ...
              <p className={style.planValue}>2 hours</p>
                ...
                <Link  to={"/choose-gateway"} className={`btn ${style.compareBtn} mt-2`}>
                  Start for free
                </Link>
